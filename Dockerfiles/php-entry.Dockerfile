...
RUN apt update
RUN apt-get install -y curl php7.1-fpm php7.1-cli php7.1-mysql php7.1-pgsql php7.1-opcache php7.1-curl php7.1-common php7.1-mbstring php7.1-xml php7.1-zip
...
CMD service php7.1-fpm start && nginx -c /etc/nginx/nginx.conf -g "daemon off;"